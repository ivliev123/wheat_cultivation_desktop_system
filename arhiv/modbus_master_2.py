...
client = ModbusSerialClient(framer="rtu", port="COM3", stopbits=1, bytesize=8, parity="N", baudrate=115200, timeout=0.2)
print(client)
...
while(1):
    ...
    result = client.read_holding_registers(60, count=4,  slave=SLAVE_BOARD_ID_2)
    regs_l = result.registers
    print(regs_l)
